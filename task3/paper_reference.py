...
'''配置项
'''
folder_name='data/raw_paper/'
train_file='data/raw_paper/training_set.txt'
test_file='data/raw_paper/testing_set.txt'
output_file='data/raw_paper/output.txt'

'''全局变量
'''
train_df=pd.read_csv(train_file,sep=' ',names=['sid','tid','label'])
test_df=pd.read_csv(test_file,sep=' ',names=['sid','tid','label'])
node_df=pd.read_csv('data/raw_paper/node_information.csv',names=['id','year','title','authors','journal','abstract'])
features={}
